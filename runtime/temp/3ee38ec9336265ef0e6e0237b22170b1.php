<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\phpStudy\WWW\shop\public/../application/bis\view\location\add.html";i:1498640264;s:70:"E:\phpStudy\WWW\shop\public/../application/bis\view\public\header.html";i:1498642616;s:70:"E:\phpStudy\WWW\shop\public/../application/bis\view\public\footer.html";i:1498698684;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
  <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('location/add'); ?>">
   ...
   <!-- <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
       <p> <script id="editor"  type="text/plain" name="content" style="width:80%;height:300px;"></script></p>
      </div>
    </div>-->
