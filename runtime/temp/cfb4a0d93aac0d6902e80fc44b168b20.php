<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"E:\phpStudy\WWW\shop\public/../application/home\view\artel\index.html";i:1498814666;s:62:"E:\phpStudy\WWW\shop\public/../application/home\view\base.html";i:1498204250;s:71:"E:\phpStudy\WWW\shop\public/../application/home\view\public\header.html";i:1499312616;s:71:"E:\phpStudy\WWW\shop\public/../application/home\view\public\footer.html";i:1499068012;}*/ ?>
...
<div class="neiyeR">
    <div class="neiBT">
        <span class="mianT_span">合作社信息 | INFORMATION </span>
    </div>
    <div class="neiText">

        <div class="haide">
            <?php if(is_array($location) || $location instanceof \think\Collection || $location instanceof \think\Paginator): if( count($location)==0 ) : echo "" ;else: foreach($location as $key=>$vo): ?>
            <div class="haide_te">
                <a href="#"><img src="<?php echo $vo['logo']; ?>" width="208" height="142" alt="" /></a>
                <h1><a href="<?php echo url('artel/about',['id'=>$vo['id'],'name'=>'introduction']); ?>" class="haide_h1"><?php echo $vo['name']; ?></a></h1>
                    <p ><?php echo $vo['notes']; ?></p>
            </div>
