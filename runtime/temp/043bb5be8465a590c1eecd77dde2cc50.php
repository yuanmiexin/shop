<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\phpStudy\WWW\shop\public/../application/home\view\login\index.html";i:1499127999;}*/ ?>
...
<div class="centBox">
    <div class="top">
        <span>【<a href="<?php echo url('home/login/index'); ?>">登陆</a> 】 【<a href="<?php echo url('bis/login/index'); ?>">申请入驻</a>】  【<a href="<?php echo url('home/deal/index'); ?>">前往采购</a>】
            【<a href="<?php echo url('infor/index'); ?>">联系我们</a>】</span>
...
<div class="denlu">
    <div class="denlu_nei">
        ...
        <div class="denluR">
            ...
            <div class="den_kang">
                <table width="100%" height="155" border="0" cellspacing="0" cellpadding="0">
                    <tr >
                        ...
                        <td><input type="text" class="denl_input" value="" placeholder="邮箱/会员账号" name="username"/></td>
                    </tr>
                    <tr>
            ...
            <div class="deng_ann">
                <input type="submit"  class="deng_a"/>
                <a href="#">忘记密码？</a>
            </div>
            <div class="zhece">
                <span class="zhece_spa">还不是义乌购用户？</span><a href="<?php echo url('register'); ?>">免费注册</a> </div>
            <div class="zhano">
                <span class="l">其他用户登录：</span><a href="<?php echo url('login/index'); ?>"><img src="__STATIC__/home/images/qq.gif" /></a>            </div>
        </div>
        </form>
    </div>
